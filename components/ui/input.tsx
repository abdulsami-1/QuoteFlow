  ...
  ({ className, type, error, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          'flex h-10 w-full rounded-md border border-border-default bg-elevated px-4 py-2 text-sm text-fg-primary placeholder:text-fg-disabled transition-colors duration-150',
